...
if __name__ == "__main__":
    fetch('./','FOX2T0.txt','http://www.amsat.org/tlm/ops/FOX2T0.txt')
    fetch('./','FOXDB.tgz','http://www.amsat.org/tlm/radfxsat/FOXDB.tar.gz',extract=True)
    
    #fetch_foxt0('./')
    #fetch_foxdb('./')
    #fetch_foxdb('./AO91','https://www.amsat.org/tlm/radfxsat/FOXDB.tar.gz')
